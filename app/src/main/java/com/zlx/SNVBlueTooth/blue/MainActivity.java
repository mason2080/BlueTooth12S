package com.zlx.SNVBlueTooth.blue;
...
//        tv5.setText("均衡状态:" + (均衡状态 == 0 ? "未开启均衡" : "开启均衡"));
        ...
        tv6.setText((split[11] + "-" + split[12] + "-" + split[13] + " " + split[14] + ":" + split[15] + ":" + split[16]));
        ...
        double 最低单体电压 = calcTwoByte(split[50], split[21], 1, 0, 1);
